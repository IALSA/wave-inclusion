...
nl_augmentedPath <- "./data-unshared/raw/map/nl_augmented.csv" # input file with your manual classification
...
write.csv(d,"./sandbox/00-test-model/long_dataset.csv", row.names=F)
write.table(d,"./sandbox/00-test-model/long_dataset.dat", row.names=F, col.names=F)
write(names(d), "./sandbox/00-test-model/long_dataset_varnames.txt", sep=" ")
