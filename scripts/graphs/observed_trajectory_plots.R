#Create individual trajectories for Rush MAP using a radc_long data file created by the
#CreateFullRADCDatasetLong.R file created by Phillippe from the original raw data files.
